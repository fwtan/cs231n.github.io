...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    # shape (N, C).                                                             #
    #############################################################################
    H = X.dot(W1) + b1.reshape((1, -1))
    ReLU_H = H.copy()
    ReLU_H[H < 0] = 0
    scores = ReLU_H.dot(W2) + b2.reshape((1, -1))
    #############################################################################
    #                              END OF YOUR CODE                             #
    #############################################################################
  ...
  def predict(self, X):
    ...
    ###########################################################################
    H = X.dot(self.params['W1']) + self.params['b1'].reshape((1, -1))
    ReLU_H = H.copy()
    ReLU_H[H < 0] = 0
    scores = ReLU_H.dot(self.params['W2']) + self.params['b2'].reshape((1, -1))
